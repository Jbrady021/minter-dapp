...
const h1_presale_mint = "Pre-Sale!!";
const h1_public_mint = "Get Your Galactic Traveler Now!!";
const h2_presale_coming_soon = "Pre-Sale Countdown";
const h2_presale_mint = "Public Minting Countdown";
const p_presale_coming_soon = "Pre-Sale coming soon. Stay tuned for updates!";
...
const p_public_mint = "Join the society. Public minting is now open! 🎉";
